export const RECURSOS_FILTERS = [
  { id: 'all', label: 'Todos los Recursos', mobileLabel: 'Todo' },
  { id: 'guias', label: 'Guías para Candidatos', mobileLabel: 'Guías' },
  { id: 'entrevistas', label: 'Entrevistas', mobileLabel: 'Entrevistas' },
  { id: 'salarios', label: 'Carrera & Salarios', mobileLabel: 'Salarios' },
  { id: 'tendencias', label: 'Tendencias IT', mobileLabel: 'Tendencias' },
];
...
export const FEATURED_ARTICLE = {
  ...
  description:
    'Cómo las empresas salvadoreñas están adoptando modelos híbridos y qué significa para tu flexibilidad profesional.',
  readMin: 6,
  image:
    'https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=1200&q=80',
};

export const RECURSOS_ARTICLES = [
  {
    id: 'entrevista-senior',
    category: 'Guías',
    filter: 'guias',
